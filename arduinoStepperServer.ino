...
char dirRotation; // direction of rotations, clockwise or anticlockwise
...
void loop(){
  ...
  if ( (numCharsAvailable = client.available()) > 0){
    ...
    numRotation = &numRotationByte[0];
    //Serial.print("dbg: unsigned int numRotation ptr=");
    //Serial.println(numRotation);
    //Serial.print("dbg: unsigned int numRotationr=");
    //Serial.println(*numRotation);
